...
| `FR-SUM-001` | 記録した作業時間を集計して表示する | C | ⬜ 未作成 |
| `NFR-I18N-001` | 英語と日本語で表示を切り替える | — | ⬜ 未作成 |
| `NFR-DATA-001` | 記録したデータを永続化して再起動後も参照できる | B-9 | ⬜ 未作成 |
| `CON-LICENSE-001` | GPLv3 を維持し移植元の帰属を保持する | — | ⬜ 未作成 |
